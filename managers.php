...
include "menu.php";
include "dbconn.php";
echo "<table border=1><border-color=#FE5302><tr><th>Manager ID</th><th>Budget</th><th>Direct Reports</th><th>Total Reports</th><th>Mentee</th><th>Department ID</th></tr>";
...
if($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        echo "<td><td>" . $row["mgr_id"] . "</td><td>" . $row["budget"] . "</td><td>"
            ...
            . $row["dept_id"] . "</td><td>" . $row["team_name"] . "</td></tr>";
