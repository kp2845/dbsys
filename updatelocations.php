...
$sql = "update locations set location_type = ?, location_status = ?, location_tax = ?, location_capacity = ? where location_id = ?";
...
$stmt->bind_param("sssis", $location_type, $location_status, $location_tax, $location_capacity, $location_id);
